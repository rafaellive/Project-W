...
const _logger = debug.extend("UserAppointmentCal");
...
class UserAppointmentCal extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      modal: false,
  ...
  render() {
    ...
    return (
      <React.Fragment>
                  <div>
              <h3 className="text-center">Appointments Booked</h3>
          </div>
        <FullCalendar
        height="40%"
          plugins={[listPlugin]}
        ...
        >
          <Fade in={this.state.modal}>
            ...
            <img src="https://sabio-training.s3-us-west-2.amazonaws.com/welrus/8f58cbc1-db26-4e2c-82d3-975c5616c488-welrus_logotype_3.2.png"
              ...
              <h2 id="appointment-practice-name">
...
export default withStyles(styles, { withTheme: true })(UserAppointmentCal);
